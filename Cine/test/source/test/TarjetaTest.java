...
/**
 * Esta es la clase usada para verificar que los métodos de la clase Tarjeta estén correctamente implementados
 */
public class TarjetaTest extends TestCase
{
    ...
    {
        setupEscenario1( );
        assertEquals( "El saldo inicial es inválido.", Tarjeta.CARGA_INICIAL, tarjeta.darCantidadDisponible( ) );
    }
    ...
    public void testRecargar( )
    {
        ...
        tarjeta.recargar( );
        assertEquals( "El saldo después de la recarga es inválido.", saldoTarjeta, tarjeta.darCantidadDisponible( ) );
    }
    ...
    public void testResta( )
    {
        ...
        assertEquals( "El saldo después de una resta de dinero es inválido.", saldoTarjeta, tarjeta.darCantidadDisponible( ) );
    }
    ...
    public void testRestaMayor( )
    {
        ...
        try
        {
            ...
            fail( "No debería poder restar una cantidad mayor a la que tiene disponible" );
        }
        catch( Exception e )
        {
